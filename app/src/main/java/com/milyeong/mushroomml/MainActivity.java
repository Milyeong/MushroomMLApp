...
import com.milyeong.mushroomml.ml.MushroomPoison;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void classifyImage(Bitmap image){
        try {
            MushroomPoison model = MushroomPoison.newInstance(getApplicationContext());
            ...
            MushroomPoison.Outputs outputs = model.process(inputFeature0);
